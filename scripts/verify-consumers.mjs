  ...
  try {
    ...
    await writeFile(
      ...
      `import type { HistogramMetricPoint, MetricIntegerValue, MetricPoint } from ${JSON.stringify(`${npmPackage}/types`)};\n` +
        ...
        `void [integerValue, point, invalidIntegerValue, invalidHistogram, invalidTimestamp];\n`,
    );
    run(
      process.execPath,
      [
